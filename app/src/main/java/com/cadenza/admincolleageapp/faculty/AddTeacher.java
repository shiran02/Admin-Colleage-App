...
import com.cadenza.admincolleageapp.NoticeData;
import com.cadenza.admincolleageapp.R;
import com.cadenza.admincolleageapp.UploadNotice;
    ...
    private void insertData() {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddTeacher.this,"Some thing went to Wrong",Toast.LENGTH_SHORT).show();
            }
        });
